...
| **电池与MOS状态上报** | `0x04400000U` | 50ms (故障)<br>100ms (心跳)<br>事件跳变即时 | 8 字节 | Byte 0: BAT1 状态 (0x00~0x04)<br>Byte 1: BAT2 状态 (0x00~0x04)<br>Byte 2: BAT1 主放电 MOS (0/1)<br>Byte 3: BAT1 回充 MOS (0/1)<br>Byte 4: BAT2 主放电 MOS (0/1)<br>Byte 5: BAT2 回充 MOS (0/1)<br>Byte 6: BAT1 与 BAT2 进入 Bus-Off 累计次数之和 (0~255 饱和)<br>Byte 7: FDCAN3 进入 Bus-Off 累计次数 (0~255 饱和) |
